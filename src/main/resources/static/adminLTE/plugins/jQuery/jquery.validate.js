...
$.extend($.validator, {
	...
	messages: {
		...
		date: "Por favor, indique uma data válida.",
		dateISO: "Por favor, indique um datas válidas (ISO).",
		...
		rangelength: $.validator.format("Por favor insira um valor entre {0} e {1} caracteres grandes."),
